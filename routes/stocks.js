...
router.post('/stocks/create', (req, res) => {
    stocks.create(req.body.product_id, req.body.room, req.body.warehouse, req.body.critical_stock).then(data => {
        res.json(data)
    }).catch(err => {
        res.json(err)
    })
...
router.post('/stocks/update', (req, res) => {
    stocks.update(req.body.id, req.body.room, req.body.warehouse, req.body.critical_stock).then(data => {
        res.json(data)
    }).catch(err => {
        res.json(err)
    })
...
// router.get('/stocks/find_all_total_equal_critical', (req, res) => {
//     stocks.find_all_total_equal_critical().then(data => {
//         res.json(data)
//     }).catch(err => {
//         res.json(err)
//     })
