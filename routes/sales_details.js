...
router.post('/sales_details/find_all_count_by_date_range_and_product_group_by_price', (req, res) => {
    sales_detail.find_all_count_by_date_range_and_product_group_by_price(req.body.start_date, req.body.end_date, req.body.product_id)
    .then(data => {
        res.json(data)
    }).catch(err => {
        res.json(err)
...
router.post('/sales_details/find_all_count_by_date_range_group_by_product', (req, res) => {
    sales_detail.find_all_count_by_date_range_group_by_product(req.body.start_date, req.body.end_date)
    .then(data => {
        res.json(data)
    }).catch(err => {
        res.json(err)
