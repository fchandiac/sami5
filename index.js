...
const stocks = require('./js/promises/stocks')
...
const order_loader_form = document.getElementById('order_loader_form')

if (config.orders == true){
    orders_tab_btn.classList.remove('collapse')
    order_btn.classList.remove('collapse')
    order_loader_form.classList.remove('collapse')
    
} else {
    orders_tab_btn.classList.add('collapse')
    order_btn.classList.add('collapse')
    order_loader_form.classList.add('collapse')
}
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    cash_register_code_input.focus()
    sales.render_sale_product_grid()
...
//--------- SALE PRODUCTS RENDER GRID -----------//
const start_sale_product_grid_date_imput = document.getElementById('start_sale_product_grid_date_imput')
const end_sale_product_grid_date_imput = document.getElementById('end_sale_product_grid_date_imput')
const render_sale_products_grid_btn = document.getElementById('render_sale_products_grid_btn')

render_sale_products_grid_btn.addEventListener('click', () => {
    sales.render_sale_product_grid(
        start_sale_product_grid_date_imput.value,
        end_sale_product_grid_date_imput.value
    )
})
...
// load_critical_alerts()

// function load_critical_alerts(){
//     stocks.alert_critical()
//     .then(res => {
...
const stock_alert_btn = document.getElementById('stock_alert_btn')
stock_alert_btn.addEventListener('click', () => {
    stocks.alert_critical()
    .then(res => {
        if (res.length >= 1){
            $('#alert_stock_modal').modal('show')
        }
    })
    .catch(err => {err})
