...
function find_all_count_by_date_range_group_by_product(start_date, end_date){
    ...
    let data = {'start_date': start_date, 'end_date': end_date}
    const sale = new Promise((resolve, reject) => {
        fetch(server_url + '/sales_details/find_all_count_by_date_range_group_by_product', {
            method: 'POST',
            body: JSON.stringify(data),
            headers: {'Content-Type': 'application/json'}
        }).then(res => {
...
module.exports = {create,
    ...
    find_all_count_by_date_range_group_by_product
}